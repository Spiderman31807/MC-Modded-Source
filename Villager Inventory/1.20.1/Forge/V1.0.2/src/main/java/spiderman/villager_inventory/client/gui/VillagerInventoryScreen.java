package spiderman.villager_inventory.client.gui;
...
public class VillagerInventoryScreen extends AbstractContainerScreen<VillagerInventoryMenu> {
	private final static HashMap<String, Object> guistate = VillagerInventoryMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	private final VillagerInventoryMenu menu;
	private final LivingEntity boundEntity;

	public VillagerInventoryScreen(VillagerInventoryMenu container, Inventory inventory, Component text) {
