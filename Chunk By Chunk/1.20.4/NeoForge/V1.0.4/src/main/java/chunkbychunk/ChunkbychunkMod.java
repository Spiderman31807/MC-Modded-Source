...
public class ChunkbychunkMod {
	public static final Logger LOGGER = LogManager.getLogger(ChunkbychunkMod.class);
	public static final String MODID = "chunkbychunk";

	public ChunkbychunkMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		// Start of user code block mod init
		PlayerVariables.ATTACHMENT_TYPES.register(modEventBus);
