...
public class ManagerScreen extends AbstractContainerScreen<ManagerMenu> {
	...
	public void addButton(int xChunk, int zChunk, int x, int y) {
		...
		ImageButton ChuckButton = new ImageButton(this.leftPos + x, this.topPos + y, 10, 10, 0, 0, 10, new ResourceLocation("chunkbychunk:textures/screens/atlas/imagebutton_chunk_vaild.png"), 10, 20, e -> {
			ChunkbychunkMod.PACKET_HANDLER.sendToServer(new ManagerButton(0, new int[] { chunk.x, chunk.z }));
