...
public class GlobalData implements SuggestionProvider<String> {
	public static final List<EntityType> supported = List.of(EntityType.VILLAGER, EntityType.WITCH, EntityType.ZOMBIE, EntityType.HUSK,
		...
		EntityType.PIG, EntityType.CHICKEN, EntityType.CAT);
	...
	public static List<EntityType> getSupported() {
		ArrayList<EntityType> order = new ArrayList();

		//Human
		order.add(EntityType.PLAYER);
		order.add(EntityType.VILLAGER);

		//Illager
		order.add(EntityType.WITCH);
		order.add(EntityType.PILLAGER);
		order.add(EntityType.VINDICATOR);
		order.add(EntityType.EVOKER);
		order.add(EntityType.ILLUSIONER);

		//Zombie
		order.add(EntityType.ZOMBIE);
		order.add(EntityType.HUSK);
		order.add(EntityType.DROWNED);
		order.add(EntityType.ZOMBIE_VILLAGER);
		order.add(EntityType.ZOMBIFIED_PIGLIN);

		//Skeleton
		order.add(EntityType.SKELETON);
		order.add(EntityType.STRAY);
		order.add(EntityType.WITHER_SKELETON);

		//Spider
		order.add(EntityType.SPIDER);
		order.add(EntityType.CAVE_SPIDER);
	...
	public static boolean isRaider(EntityType type) {
