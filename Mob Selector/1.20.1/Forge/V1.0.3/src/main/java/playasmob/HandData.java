...
public class HandData {
	...
	public HandData(EntityRendererProvider.Context context, EntityTypeData typeData, Hand hand, boolean outerHand) {
		model = hand;
		if(outerHand)
			outerModel = new HandModel(context.bakeLayer(typeData.getModelLayer(true)), true);
	}

	public HandData(EntityRendererProvider.Context context, EntityTypeData typeData, Hand hand, Hand outerHand) {
		model = hand;
		outerModel = outerHand;
	}
