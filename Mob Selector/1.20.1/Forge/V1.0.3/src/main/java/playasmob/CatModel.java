...
@OnlyIn(Dist.CLIENT)
public class CatModel extends OcelotModel<AbstractClientPlayer> {
   	...
   	public void prepareMobModel(AbstractClientPlayer player, float p_102344_, float p_102345_, float p_102346_) {
   	  	if(MobData.get(player).typeData instanceof CatData catData) {
      		this.lieDownAmount = catData.getLieDownAmount(p_102346_);
      		this.lieDownAmountTail = catData.getLieDownAmountTail(p_102346_);
      		this.relaxStateOneAmount = catData.getRelaxStateOneAmount(p_102346_);
      		...
      		super.prepareMobModel(player, p_102344_, p_102345_, p_102346_);
      		if (catData.isInSittingPose()) {
   ...
   public void setupAnim(AbstractClientPlayer p_102348_, float p_102349_, float p_102350_, float p_102351_, float p_102352_, float p_102353_) {
