...
public class WitchRenderer extends MobRenderer<WitchModel<AbstractClientPlayer>> {
   	...
   	public WitchRenderer(EntityRendererProvider.Context context) {
      	...
      	this.addLayer(new MobHeadLayer<>(this, context.getModelSet(), 0.99f, 0.99f, 0.99f, context.getItemInHandRenderer()));
      	this.addLayer(new MobElytraLayer<>(this, context.getModelSet(), null, null, 1f));
   	}
