...
public class EndermanRenderer extends MobRenderer<EndermanModel<AbstractClientPlayer>> {
   ...
   public EndermanRenderer(EntityRendererProvider.Context context) {
      ...
      this.addLayer(new CustomHeadLayer<>(this, context.getModelSet(), 1f, 1f, 1f, context.getItemInHandRenderer()));
      this.addLayer(new MobElytraLayer<>(this, context.getModelSet(), new Vec3(0, -0.8, 0), null, 1f));
      //this.addLayer(new MobItemLayer<>(this, context.getItemInHandRenderer(), new Vec3(-0.09, 0, -3)));
   }
