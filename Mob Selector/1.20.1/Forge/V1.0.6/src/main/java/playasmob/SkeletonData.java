...
public class SkeletonData extends EntityTypeData implements GolemAttack {
	...
	public double getMyRidingOffset() {
   	...
   	public void buildFoodInfo() {
   		super.buildFoodInfo();
   		this.addFoodInfo(Items.BONE, FoodMapper.create(true), null);
   		this.addFoodInfo(Items.BONE_MEAL, FoodMapper.create(true, true), null);
   		this.addFoodInfo(Items.BONE_BLOCK, FoodMapper.create(true, new FoodEffect(MobEffects.DAMAGE_RESISTANCE, 600, 1, 1f)), null);
   	}

   	@Override
   	public boolean preventEating() {
   		return data.player.getHealth() == data.player.getMaxHealth();
   	}
