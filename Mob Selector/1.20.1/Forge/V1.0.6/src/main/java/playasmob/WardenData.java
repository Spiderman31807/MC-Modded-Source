...
public class WardenData extends EntityTypeData implements VibrationSystem.User, VibrationSystem, GolemAttack {
  	...
  	public ArrayList<UUID> highlightMobs = new ArrayList();
   	...
   	public List<MobAttribute> getAbilities(EntityType type) {
   		...
   		abilities.add(MobAttribute.ability(3, Component.translatable("playasmob.ability.sonicboom")).fullOnly());
   		return abilities;
   	}
	...
	public boolean hasHand() {
		return this.sniffAnimation == 0 && this.roarAnimation == 0 && this.sonicAnimation == 0 && this.attackAnimation == 0;
	}
	...
	public void press(int ability, boolean pressed) {
		...
		if(ability == 2 && this.roarCooldown == 0 && useable)
			this.startRoaring();
		if(ability == 3 && this.sonicCooldown == 0 && useable && data.fullyMobMode)
			this.startCharging();
	}
	...
	public void setupHand(HandData hand) {
   	...
   	public void buildFoodInfo() {
   		super.buildFoodInfo();
   		this.addFoodInfo(Items.SCULK_VEIN, FoodMapper.create(0, true), null);
   		this.addFoodInfo(Items.SCULK, FoodMapper.create(0), null);
   		this.addFoodInfo(Items.SCULK_SENSOR, FoodMapper.create(0), null);
   		this.addFoodInfo(Items.SCULK_CATALYST, FoodMapper.create(0), null);
   	}
	...
	public void ate(ItemStack stack) {
   	...
   	public EntityDimensions getDimensions(Pose pose) {
      	...
      	return this.isDiggingOrEmerging() ? EntityDimensions.fixed(dimensions.width, 1f) : dimensions;
   	}
