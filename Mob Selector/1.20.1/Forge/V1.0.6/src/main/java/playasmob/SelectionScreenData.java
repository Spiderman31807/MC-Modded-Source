...
public class SelectionScreenData {
	...
	public static void init() {
		...
		addGroup(new SelectionGroup("human", EntityType.VILLAGER, List.of(EntityType.VILLAGER, EntityType.WANDERING_TRADER, EntityType.SNOW_GOLEM, EntityType.IRON_GOLEM)));
		addGroup(new SelectionGroup("illager", EntityType.WITCH, List.of(EntityType.VEX, EntityType.WITCH, EntityType.VINDICATOR, EntityType.PILLAGER, EntityType.RAVAGER, EntityType.EVOKER, EntityType.ILLUSIONER)));
