...
public class SpiderRenderer extends MobRenderer<SpiderModel<AbstractClientPlayer>> {
   	...
   	public SpiderRenderer(EntityRendererProvider.Context context, ModelLayerLocation model) {
      	...
      	//this.addLayer(new MobHeadLayer<>(this, context.getModelSet(), 0.8f, 0.8f, 0.8f, context.getItemInHandRenderer()));
      	this.addLayer(new MobElytraLayer<>(this, context.getModelSet(), new Vec3(0, 0.8, -0.18), new Vec3(75, 0, 0), 0.75f));
   	}
