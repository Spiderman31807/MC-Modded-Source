...
public class SkeletonData implements EntityTypeData<SkeletonRenderer> {
	...
	public void respawn() {
		this.strayConversion = false;
		this.inPowderSnowTime = 0;
		this.conversionTime = 0;
	}

	public SkeletonRenderer getRenderer(EntityRendererProvider.Context context) {
	...
	public void hurtEntity(LivingHurtEvent event) {
   	...
   	public void doFreezeConversion() {
      	...
      	data.changeMob(EntityType.STRAY, this.save());
