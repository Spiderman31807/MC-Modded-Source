...
public class WitherSkeletonRenderer extends SkeletonRenderer {
   ...
   public ResourceLocation getTextureLocation(AbstractClientPlayer p_116458_) {
      return WITHER_SKELETON_LOCATION;
   }

   protected void scale(AbstractClientPlayer p_116460_, PoseStack p_116461_, float p_116462_) {
