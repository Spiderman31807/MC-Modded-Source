...
@OnlyIn(Dist.CLIENT)
public class IllagerModel extends HierarchicalModel<AbstractClientPlayer> implements ArmedModel, HeadedModel {
   ...
   public void setupAnim(AbstractClientPlayer player, float p_102929_, float p_102930_, float p_102931_, float p_102932_, float p_102933_) {
      ...
      AbstractIllager.IllagerArmPose armPose = AbstractIllager.IllagerArmPose.NEUTRAL;
      if(MobData.get(player).typeData instanceof RaiderData data)
      	 armPose = data.getArmPose();
      ...
      if (armPose == AbstractIllager.IllagerArmPose.ATTACKING) {
         if (player.getMainHandItem().isEmpty()) {
            ...
            PiglinModel.swingWeaponDown(this.rightArm, this.leftArm, player, this.attackTime, p_102931_);
         }
