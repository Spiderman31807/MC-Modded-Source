...
@OnlyIn(Dist.CLIENT)
public class ZombieVillagerModel extends HumanoidModel<AbstractClientPlayer> implements VillagerHeadModel {
   ...
   public void setupAnim(AbstractClientPlayer player, float p_104176_, float p_104177_, float p_104178_, float p_104179_, float p_104180_) {
      super.setupAnim(player, p_104176_, p_104177_, p_104178_, p_104179_, p_104180_);
      AnimationUtils.animateZombieArms(this.leftArm, this.rightArm, MobData.get(player).isAggressive(), this.attackTime, p_104178_);
   }
