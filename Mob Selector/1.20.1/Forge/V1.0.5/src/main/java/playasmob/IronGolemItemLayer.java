...
@OnlyIn(Dist.CLIENT)
public class IronGolemItemLayer extends RenderLayer<AbstractClientPlayer, IronGolemModel> {
   private final BlockRenderDispatcher blockRenderer;

   public IronGolemItemLayer(RenderLayerParent<AbstractClientPlayer, IronGolemModel> p_234842_, BlockRenderDispatcher p_234843_) {
      super(p_234842_);
      this.blockRenderer = p_234843_;
   }

   public void render(PoseStack p_117172_, MultiBufferSource p_117173_, int p_117174_, AbstractClientPlayer p_117175_, float p_117176_, float p_117177_, float p_117178_, float p_117179_, float p_117180_, float p_117181_) {
