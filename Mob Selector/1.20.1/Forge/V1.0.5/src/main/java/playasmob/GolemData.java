...
public class GolemData extends EntityTypeData implements ZombieAttack, SkeletonAttack, SpiderAttack, IllagerAttack {
	...
	public void preTick() {
   	...
   	public void buildFoodInfo() {
   		this.addFoodInfo(Items.IRON_NUGGET, this.buildFood(0, 0, true, true, false), null);
   		this.addFoodInfo(Items.IRON_INGOT, this.buildFood(0, 0), null);
   		this.addFoodInfo(Items.IRON_BLOCK, this.buildFood(0, 0), null);
   	}
