...
@OnlyIn(Dist.CLIENT)
public class VexModel extends HierarchicalModel<AbstractClientPlayer> implements ArmedModel, HeadedModel {
   ...
   public void setupAnim(AbstractClientPlayer player, float p_104029_, float p_104030_, float p_104031_, float p_104032_, float p_104033_) {
      ...
      if(MobData.get(player).isAggressive()) {
         this.body.xRot = 0.0F;
         this.setArmsCharging(player.getMainHandItem(), player.getOffhandItem(), f);
      } else {
