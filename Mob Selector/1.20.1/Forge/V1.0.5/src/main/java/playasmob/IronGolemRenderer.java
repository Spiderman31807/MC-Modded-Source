...
public class IronGolemRenderer extends MobRenderer<IronGolemModel> {
   ...
   public IronGolemRenderer(EntityRendererProvider.Context context) {
      ...
      this.addLayer(new MobElytraLayer<>(this, context.getModelSet(), new Vec3(0, -0.5, 0), 1.35f));
      this.addLayer(new MobItemLayer<>(this, context.getItemInHandRenderer(), new Vec3(0.4f, 0f, 0.4f)));
   }
